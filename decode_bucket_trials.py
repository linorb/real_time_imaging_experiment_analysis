...
from replays.decode_bucket_trials import count_edge_bins
...
def test_all_bucket_trials(data, name):
    ...
    for session_index in range(number_of_sessions):
        ...
        decoded_bins_first_bucket.append\
            (test_bucket_trial(first_bucket_events, p_neuron_bin, EDGE_BINS))
        last_bucket_events = data[name]['bucket_events_traces']['last']\
                                                               [session_index]
        decoded_bins_last_bucket.append\
            (test_bucket_trial(last_bucket_events, p_neuron_bin, EDGE_BINS))
...
def main():
    for i, mouse in enumerate(MOUSE):
        ...
        'bambi_first_bucket' = data['nitzan']['decoded_bucket_bins']['first'],
        'bambi_last_bucket' = data['nitzan']['decoded_bucket_bins']['last'])
